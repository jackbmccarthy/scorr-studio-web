...
import { Button, Card, CardContent, Badge, Input, Label, Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, Select, Avatar, AvatarFallback } from "@/components/ui";
import {
  ArrowLeft,
  Save,
  Trash2,
...
function EditTeamContent() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      router.push(`/app/competitions/${competitionId}/teams`);
    } catch (err) {
  ...
  if (team === undefined || competition === undefined) {
    return (
        ...
        <div className="container mx-auto px-4 py-8">
          <FadeIn>
            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
              ...
              <span>/</span>
              <Link href={`/app/competitions/${competitionId}/teams`} className="hover:text-foreground transition-colors">
                Teams
              </Link>
              <span>/</span>
